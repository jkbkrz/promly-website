...
export default function Footer({ props }) {
    ...
    return <span className="text-neutral-500 block text-sm text-center m-6" {...props}>
        ...
        Created and developed by <a href="http://krauza.tech" target="_blank" className="text-blue-600 hover:underline font-mono">krauza.tech</a><br /> © 2021 - 2024 Promly - All Rights Reserved.
    </span>
}