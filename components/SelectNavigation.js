        ...
        <div>
            <div className="inline-block mr-2">
                ...
                <select
                    ...
                    className={`${searchParams.get("category") != null ? 'border-blue-500 dark:border-blue-500' : 'border-gray-300 dark:border-zinc-700'} bg-gray-50 border text-gray-900 rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-black  dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500`}
                >
                    {children.categories}
                </select>
            </div>
