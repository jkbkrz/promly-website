...
export default function HomeSearch() {
    ...
    return <form onSubmit={handleSubmit}>
        <div className="relative max-w-md sm:max-w-xl mx-auto">
            <input disabled={loading} onChange={(e) => setQuery(e.target.value)} ref={el} type="search" autoComplete="off" id="default-search" className="block bg-white dark:bg-black pl-5 p-4 text-black dark:text-white border border-gray-300 dark:border-zinc-700 rounded-full w-full focus:outline-none focus:ring" required></input>
            ...
            ) : <button type="submit" className="text-black absolute right-2 bottom-3 font-medium rounded-lg text-sm px-4 py-2">
