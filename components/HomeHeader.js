...
const StickyNavbar = () => {
    return (
        <motion.nav
            ...
            className="fixed z-50 flex justify-between nav-bg px-4 py-2 rounded-full ts-bg left-1/2 top-6">
            <ul className="flex items-center">
                <li className="px-2 text-white text-md">
                    <Link href={"/"}>Promly</Link>
                </li>
                <li className="px-2 text-white text-md">
                ...
                <li className="px-4 py-2 ml-2 text-white bg-black rounded-full text-md ">
                    <Link href={"https://onelink.to/svwgar"}>Pobierz</Link>
                </li>
            </ul>
        </motion.nav>
    )
