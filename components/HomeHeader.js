...
export default function HomeHeader() {
    ...
    return <nav className={`top-0 z-10 mx-auto fixed bg-white bg-opacity-80 dark:bg-black dark:bg-opacity-90 backdrop-blur-xl backdrop-saturate-150 w-screen flex items-center justify-between py-4 px-8  border-b border-b-black border-opacity-10 dark:border-b-zinc-800`} style={{ maxWidth: 1920 }}>
